...
# with command line options: Configuration/Generator/python/SingleNuE10_cfi.py --conditions PHYS14_25_V2 --eventcontent RAWSIM -s GEN,SIM,DIGI,L1,DIGI2RAW --datatier GEN-SIM-RAW --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --python zerobias_25ns_pu175.py --fileout file:gen_sim_raw.root --pileup_input dbs:/MinBias_TuneA2MB_13TeV-pythia8/Fall13-POSTLS162_V1-v1/GEN-SIM --pileup AVE_175_BX_25ns -n 1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/SingleNuE10_cfi.py nevts:1'),
...
# Other statements
process.mix.input.nbPileupEvents.averageNumber = cms.double(PILEUPVAL)
process.mix.bunchspace = cms.int32(BUNCHSPACE)
...
process.GlobalTag = GlobalTag(process.GlobalTag, 'PHYS14_BUNCHSPACE_V2', '')
...
# NOTE: customisation of the process
#process.hcalRawData.HF = cms.untracked.InputTag("simHcalDigis")
